      ...
      <div className="container">
        <nav className="pb-4">
          ...
          <div className="lg:hidden flex items-center ms-auto px-2.5">
            <button className="hs-collapse-toggle inline-flex items-center justify-center h-9 w-12 rounded-md border border-white/40 bg-default-100/5"
                    type="button"
            ...
            <ul id="navbar-navlist" className="navbar-nav">
              {
                navMenu.map((list, index)=> (
                  <li key={index} onClick={()=>
                   setActiveComponent(list)} className="nav-item">
